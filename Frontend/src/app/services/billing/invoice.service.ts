...
export class InvoiceService {
  ...
  delete(id){
     return this.http.delete(`${this.baseUrl}/invoice/${id}`, { headers: this.headers}).map((res:Response) => res.json());
  }

  getOptions(projectId){
     return this.http.get(`${this.baseUrl}/invoice/${projectId}/options`, { headers: this.headers}).map((res:Response) => res.json());
  }

  sendToDaf(id){
     return this.http.put(`${this.baseUrl}/invoice/${id}/sendToDaf`, {}, { headers: this.headers}).map((res:Response) => res.json());
  }

  reject(id){
     return this.http.put(`${this.baseUrl}/invoice/${id}/reject`, {}, { headers: this.headers}).map((res:Response) => res.json());
  }

  annulment(id){
     return this.http.put(`${this.baseUrl}/invoice/${id}/annulment`, {}, { headers: this.headers}).map((res:Response) => res.json());
  }

  approve(id, invoiceNumber){
     return this.http.put(`${this.baseUrl}/invoice/${id}/approve/${invoiceNumber}`, {}, { headers: this.headers}).map((res:Response) => res.json());
  }
