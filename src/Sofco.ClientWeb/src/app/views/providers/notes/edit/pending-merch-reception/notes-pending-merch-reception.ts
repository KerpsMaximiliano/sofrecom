...
@Component({
    selector: 'notes-pending-merch-reception',
    templateUrl: './notes-pending-merch-reception.html',
    styleUrls: ['./notes-pending-merch-reception.scss']
})

export class NotesPendingMerchReception {
