...
@Component({
    selector: 'notes-purchasing-sector',
    templateUrl: './notes-purchasing-sector.html'
})

export class NotesPurchasingSector {
    ...
    formProviderGrid: FormGroup = new FormGroup({});
    ...
    ngOnInit(): void{
        this.inicializar();
        setInterval(() => {
            console.log(this.formProviderGrid);
    ...
    inicializar() {
        ...
        this.providersAreaService.get(this.currentNote.providerAreaId).subscribe(d => {
            ...
            this.providersGrid.forEach(p => {
                this.formProviderGrid.addControl(p.providerId, new FormControl(null))
            });
            this.show = true;
        })
    ...
    agregarProveedor() {
        ...
        this.formProviderGrid.addControl(busqueda.id, new FormControl(null));
    }
    ...
    eliminarProveedor(index: number) {
        ...
        this.formProviderGrid.removeControl(this.providersGrid[index].providerId);
