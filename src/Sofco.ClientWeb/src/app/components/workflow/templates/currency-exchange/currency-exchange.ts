...
@Component({
  selector: 'wf-curreny-exchange',
  templateUrl: './currency-exchange.html'
})
export class WfCurrencyExchangeComponent implements OnDestroy  {

    @ViewChild('currencyExchangeModal') modal;
    public currencyExchangeModalConfig: Ng2ModalConfig = new Ng2ModalConfig(
