...
{
    public class RequestNoteGrabarBorradorCommand : IRequestNoteCommand<RequestNoteSubmitBorradorDTO>
    {

        private readonly IRequestNoteService _requestNoteService;

        public RequestNoteGrabarBorradorCommand(IRequestNoteService requestNoteService)
        {
