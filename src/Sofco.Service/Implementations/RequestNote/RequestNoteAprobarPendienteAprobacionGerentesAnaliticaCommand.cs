...
{
    public class RequestNoteAprobarPendienteAprobacionGerentesAnaliticaCommand : IRequestNoteCommand<RequestNoteSubmitPendienteAprobacionGerentesAnaliticaDTO>
    {

        private readonly IRequestNoteService _requestNoteService;

        public RequestNoteAprobarPendienteAprobacionGerentesAnaliticaCommand(IRequestNoteService requestNoteService)
        {
