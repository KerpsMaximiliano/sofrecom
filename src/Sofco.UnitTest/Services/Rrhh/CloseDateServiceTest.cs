...
namespace Sofco.UnitTest.Services.Rrhh
{
    ...
    public class CloseDateServiceTest
    {
        ...
        public void ShouldAdd()
        {
            ...
            {
                new CloseDate { Id = 1, Day = 10, Month = 9, Year = 2029 },
                new CloseDate { Id = 2, Day = 10, Month = 10, Year = 2029 },
                new CloseDate { Day = 10, Month = 11, Year = 2029 },
                new CloseDate { Day = 10, Month = 12, Year = 2029 },
            };
