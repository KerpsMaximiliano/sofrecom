...
namespace Sofco.UnitTest.Services
{
    ...
    public class UserServiceTest
    {
        ...
        public void ShouldPassActive(bool active)
        {
            ...
            Assert.AreEqual(active ? Resources.es.Admin.User.Enabled : Resources.es.Admin.User.Disabled, $"{messageActual.Folder}.{messageActual.Code}");
        ...
        public void ShouldFailActive()
        {
            ...
            Assert.IsNotNull(messageActual);
            Assert.AreEqual(Resources.es.Admin.User.NotFound, $"{messageActual.Folder}.{messageActual.Code}");
