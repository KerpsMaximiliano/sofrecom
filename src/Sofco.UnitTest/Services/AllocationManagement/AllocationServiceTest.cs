...
namespace Sofco.UnitTest.Services.AllocationManagement
{
    ...
    public class AllocationServiceTest
    {
        ...
        public void ValidatePercentageCheckError()
        {
            ...
            Assert.True(response.Messages.Any(x => x.Folder == Resources.es.AllocationManagement.Allocation.WrongPercentage));
        }
        ...
        public void ValidatePercentageCheckSuccess()
        {
            var parameters = new AllocationDto
            {
                ...
                {
                    new AllocationMonthDto { AllocationId = 0, Percentage = 100, Date = new DateTime(2018, 1, 1) },
                    new AllocationMonthDto { AllocationId = 0, Percentage = 0, Date = new DateTime(2018, 2, 1)},
                    new AllocationMonthDto { AllocationId = 0, Percentage = 50, Date = new DateTime(2018, 3, 1)},
                }
            };
        ...
        public void ReleaseDateRequired()
        {
            ...
            Assert.True(response.HasErrors());
            Assert.True(response.Messages.Any(x => x.Folder == Resources.es.AllocationManagement.Allocation.ReleaseDateIsRequired));
        ...
        public void CannotAddAllocationWith3AllocationsOverlapped()
        {
            ...
            Assert.True(response.HasErrors());
            Assert.True(response.Messages.Any(x => x.Folder == Resources.es.AllocationManagement.Allocation.CannotBeAssign));
