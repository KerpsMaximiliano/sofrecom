...
namespace Sofco.WebApi.Controllers.RequestNote
{
    ...
    public class RequestNoteCambiosEstadoController : ControllerBase
    {
        ...
        {
            this.requestNoteService.ChangeStatus(requestNote, Domain.RequestNoteStates.RequestNoteStatus.Cerrada);
        ...
        {
            this.requestNoteService.ChangeStatus(requestNote, Domain.RequestNoteStates.RequestNoteStatus.SolicitadaAProveedor);
        ...
        {
            this.requestNoteService.ChangeStatus(requestNote, Domain.RequestNoteStates.RequestNoteStatus.Rechazada);
        ...
        {
            this.requestNoteService.ChangeStatus(requestNote, Domain.RequestNoteStates.RequestNoteStatus.PendienteProcesarGAF);
        ...
        {
            this.requestNoteService.ChangeStatus(requestNote, Domain.RequestNoteStates.RequestNoteStatus.PendienteAprobaciónDAF);
        ...
        {
            this.requestNoteService.ChangeStatus(requestNote, Domain.RequestNoteStates.RequestNoteStatus.Aprobada);
        ...
        {
            this.requestNoteService.ChangeStatus(requestNote, Domain.RequestNoteStates.RequestNoteStatus.PendienteAprobaciónAbastecimiento);
        ...
        {
            this.requestNoteService.ChangeStatus(requestNote, Domain.RequestNoteStates.RequestNoteStatus.PendienteRevisiónAbastecimiento);
        ...
        {
            this.requestNoteService.ChangeStatus(requestNote, Domain.RequestNoteStates.RequestNoteStatus.PendienteAprobaciónGerentesAnalítica);
        ...
        {
            this.requestNoteService.ChangeStatus(requestNote, Domain.RequestNoteStates.RequestNoteStatus.FacturaPendienteAprobaciónGerente);
        ...
        {
            this.requestNoteService.ChangeStatus(requestNote, Domain.RequestNoteStates.RequestNoteStatus.RecibidoConforme);
            return Ok();
        }
        #endregion
    }
