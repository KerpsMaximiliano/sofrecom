...
{
    public class WorkflowBuyOrderNotificationDefault : WorkflowNotification
    {
        private readonly EmailConfig emailConfig;

        public WorkflowBuyOrderNotificationDefault(IMailSender mailSender,
            ...
            WorkflowChangeStatusParameters parameters)
        {
            ...
            var body = string.Format(MailMessageResource.WorkflowNotificationBuyOrder,
