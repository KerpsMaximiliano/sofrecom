...
{
    public class WorkflowRequestNoteNotificationReject : WorkflowNotification
    {
        private readonly EmailConfig emailConfig;

        public WorkflowRequestNoteNotificationReject(IMailSender mailSender,
            ...
            WorkflowChangeStatusParameters parameters)
        {
            ...
            var body = string.Format(MailMessageResource.WorkflowNotificationRequestNoteReject,
